...
public class Lab4Task23ListTableModel implements TableModel {
	private List<Requirement> requirements = new ArrayList<>();
	private List<TableModelListener> listeners = new ArrayList<>();
	
	private static enum Lab4Task23Filed {
		ID("ID") {
			@Override
		...
		private Lab4Task23Filed(String columnName) {
	...
	public int getColumnCount() {
		return Lab4Task23Filed.values().length;
	}

	@Override
	public String getColumnName(int columnIndex) {
		return Lab4Task23Filed.values()[columnIndex].getColumnName();
	}
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		return Lab4Task23Filed.values()[columnIndex].getValue(requirement);
	}
